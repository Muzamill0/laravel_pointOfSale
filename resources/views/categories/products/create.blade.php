        ...
        <div class="col-md-12 card p-3">
            <div class="row mb-3">
                ...
                <div class="col-6 text-end">
                    <a class=" btn btn-primary" href="{{ route('category.products', $category) }}"><i class="fas fa-arrow-left"></i> Back</a>
                </div>
            </div>
            ...
            @endif
            <form action="{{ route('category.product.create', $category) }}" method="POST" class="card p-3" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-6">
                    ...
                    <div class="col-6">
                        ...
                        <div class="col-md-12">
                            ...
                            <input class="form-control" type="number" id="s_contact" name="s_contact"
